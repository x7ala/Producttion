<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            {{ @csrf_field() }}
            @method('PUT') 
            <form method="POST" action="{{ url('update-references/'.$references->id) }}">
            <input type="hidden" name="_token" value="oA7KHCawU4mfWSUOiJQXa3cZhWPPdRmDHSRazAJO" autocomplete="off">
                 <div>
                        ...
                        <textarea name="description" class="form-control" required >{{$references->description}}</textarea>
                    </div>
